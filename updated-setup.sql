-- FocusFlow Todo App - Updated Database Setup
-- This script adds due date/time to sub-todos
...
-- Create sub_todos table with due date and time
...
-- Success message
SELECT '✅ Updated database setup completed successfully!' as status;
